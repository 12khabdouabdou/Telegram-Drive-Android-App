...
pub fn cmd_toggle_auto_backup(config: AutoBackupConfig) -> Result<(), String> {
    #[cfg(target_os = "android")]
    {
        ...
        let vm =
            unsafe { jni::JavaVM::from_raw(ctx_obj.vm().cast()) }.map_err(|e| e.to_string())?;
        ...
        let result: Result<(), String> = (|| {
            ...
            let class_name = env
                .new_string("com.cameronamer.telegramdrive.AutoBackupService")
                .map_err(|e| e.to_string())?;
            let class_obj = env
                .call_method(
                    &class_loader,
            ...
            let intent = env
                .new_object(
                    ...
                    &[
                        ...
                        jni::objects::JValue::from(&j_class),
                    ],
                )
                .map_err(|e| e.to_string())?;
            ...
            let _ = env.call_method(
                ...
                &[
                    jni::objects::JValue::from(&ext_wifi),
                    jni::objects::JValue::Bool(config.wifi_only as jni::sys::jboolean),
                ],
            );
            ...
            let _ = env.call_method(
                ...
                "(Ljava/lang/String;Z)Landroid/content/Intent;",
                &[
                    jni::objects::JValue::from(&ext_battery),
                    jni::objects::JValue::Bool(config.battery_safe as jni::sys::jboolean),
                ],
            );
            ...
            let _ = env.call_method(
                ...
                "(Ljava/lang/String;Z)Landroid/content/Intent;",
                &[
                    jni::objects::JValue::from(&ext_night),
                    jni::objects::JValue::Bool(config.night_mode as jni::sys::jboolean),
                ],
            );

            let ext_dest = env.new_string("destination").map_err(|e| e.to_string())?;
            let dest_val = env
                .new_string(&config.destination)
                .map_err(|e| e.to_string())?;
            let _ = env.call_method(
                &intent,
                "putExtra",
                ...
                &[
                    jni::objects::JValue::from(&ext_dest),
                    jni::objects::JValue::from(&dest_val),
                ],
            );
            ...
            let _ = env.call_method(
                ...
                "(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;",
                &[
                    jni::objects::JValue::from(&ext_mode),
                    jni::objects::JValue::from(&mode_val),
                ],
            );
            ...
            let folder_array = env
                .new_object_array(config.folders.len() as i32, string_class, initial_str)
                .map_err(|e| e.to_string())?;
            for (i, folder) in config.folders.iter().enumerate() {
                let j_folder = env.new_string(folder).map_err(|e| e.to_string())?;
                env.set_object_array_element(&folder_array, i as i32, j_folder)
                    .map_err(|e| e.to_string())?;
            }
            ...
            let _ = env.call_method(
                ...
                "(Ljava/lang/String;[Ljava/lang/String;)Landroid/content/Intent;",
                &[
                    jni::objects::JValue::from(&ext_folders),
                    jni::objects::JValue::from(&folder_array),
                ],
            );
    ...
    tauri::async_runtime::spawn(async move {
        loop {
            ...
            for (id, path) in pending_files {
                ...
                let net_config =
                    app_handle.state::<std::sync::Arc<crate::vpn_optimizer::NetworkConfig>>();
                ...
                let new_status = if upload_res.is_ok() {
                    "completed"
                } else {
                    "failed"
                };
